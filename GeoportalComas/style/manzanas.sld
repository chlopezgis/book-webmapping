...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>DB_Calidda — Manzanas</se:Name>
    <UserStyle>
      <se:Name>DB_Calidda — Manzanas</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#e6e3d1</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.57</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#77774f</se:SvgParameter>
        ...
        <se:Rule>
          ...
          <se:TextSymbolizer>
            <se:Label>
              <ogc:PropertyName>nombremanzana</ogc:PropertyName>
            </se:Label>
            <se:Font>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#0c0c01</se:SvgParameter>
            </se:Fill>
